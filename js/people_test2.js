$(function() {
    ...
    $(document).on('click', '.btn-add', function(e) {
        ...
        // add whatever is in the form to a new Person object
        // console.log('currentEntry', currentEntry);
        // var option = 'select option[value="' + name.sluggify() + '"]';
        // var name = currentEntry.children('.staff_name').val(),
        ...
        //
        // // Create a new Person and push it in to people
        // var staff = new Person(newid, name, type, rate, benefits);
        // people.push(staff);
